...
if TEST:
    ...
    if UNIT_TEST:
        input_filename = "unit_test_p2.txt"
else:
...
class Hand():
    ...
    def get_HandType(self, hand_txt):
        output = {}
        joker_bool = CARDS[0] in hand_txt
        ...
        joker_cnt = output.get(CARDS[0], 0)
...
def main():
    ...
    for line in list_of_list:
        for hand in line:
            lst.append(hand)
    # set_unsort = {s for s in lst}
    # set_sorted = {s for s in sorted}
    # set_diff = set_unsort - set_sorted
    # print(set_diff).
